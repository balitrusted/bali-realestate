  ...
  return (
    <div 
      className="
        ...
        prose-h2:text-lg prose-h2:leading-snug prose-h2:mt-4 prose-h2:mb-2
        prose-h3:text-base prose-h3:leading-snug prose-h3:mt-4 prose-h3:mb-2
        prose-p:mt-2 prose-p:mb-3
